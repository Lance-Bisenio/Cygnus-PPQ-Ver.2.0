<%@ Page Language="VB" AutoEventWireup="false" CodeFile="materials-request-form.aspx.vb" Inherits="inventory_materials_request_form" %>
        ...
        <table id="Standard_Tbl" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtQty" runat="server" Width="350px" AutoComplete="off" /> 
                    <%--&nbsp;&nbsp;&nbsp;
                    <b><asp:Label ID="lblCurrQty" runat="server" Text="Current Qty : 0" CssClass="BiglabelL" ></asp:Label></b>--%>
                </td> 
            </tr>
            <tr><td>&nbsp;</td></tr>
