...
<head runat="server">
    ...
    <style type="text/css">
        ...
        body {
            ...
            --c: #0000,#F0F0F0 .1deg 119.5deg,#0000 120deg;
            --g1: conic-gradient(from 60deg at 56.25% calc(425%/6),var(--c));
            --g2: conic-gradient(from 180deg at 43.75% calc(425%/6),var(--c));
            --g3: conic-gradient(from -60deg at 50% calc(175%/12),var(--c));
            background: var(--g1),var(--g1) var(--s) calc(1.73*var(--s)), var(--g2),var(--g2) var(--s) calc(1.73*var(--s)), var(--g3) var(--s) 0,var(--g3) 0 calc(1.73*var(--s)) #ECBE13;
    ...
    <form id="frmlogin" runat="server" autocomplete="off">
        ...
        <div class="container">
            <div class="d-flex justify-content-center mb-3">
                <div class="p-2"></div>
                <div class="p-2 col-4 pt-5">
                    <div class="panel panel-primary" style="width: 100%; margin: auto; box-shadow: 2px 2px 10px #000; padding: 20px; margin-top: 50px; border: solid 0px #bb1100; background-color: #fff;">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <div style="height: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 11px; color: #d4d4d4; padding-left: 10px;">
                                            Copyright © <%=Now.Year  %> <a href="http://www.**.com" style="font-weight: bold; font-size: 11px; color: #d4d4d4; font-family: Arial, Helvetica, sans-serif; text-decoration: none"
