...
Partial Class evolvemenus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Do While rs.Read
            ...
            vMenus += "<a Class='dropdown-item dropitem-text sidebar-link' href='#' onclick='showModule(""" & rs("Dependencies") & """, """ & rs("Label_Caption") & """)'>" _
                & "<img alt='' class='ml-0 mr-2 my-1' src='" & rs("Params") & "' style='margin-top:11px; width:20px;' />" _
                & rs("Label_Caption") & "</a>"
