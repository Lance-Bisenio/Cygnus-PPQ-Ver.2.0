...
Partial Class warehouse_ajax
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim ProcessItemsReceivingList As String = IIf(Request.Item("ItemToReceive") = "", "", Request.Item("ItemToReceive"))
        ...
        If ProcessItemsReceivingList.Trim <> "" Then
            ProcessItemsReceiving(ProcessItemsReceivingList)
        End If
    End Sub
    ...
    Private Sub ProcessItemsReceiving(TranType As String)
